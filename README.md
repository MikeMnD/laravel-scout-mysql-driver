...
This is a fork of [damiantw/laravel-scout-mysql-driver](https://github.com/damiantw/laravel-scout-mysql-driver)
...
`composer require mikemnd/laravel-scout-mysql-driver`
